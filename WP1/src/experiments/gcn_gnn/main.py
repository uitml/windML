...
from basic_gcnc import Mini_gnn
...
if __name__ == '__main__':
    ...
    dataset = frost_api_to_gnn_dataset(data, adj_df, 'wind_speed', n_skips=5, temporal_strength=0.6)
    ...
    optim = torch.optim.Adam(model.parameters(), lr=0.001, weight_decay=5e-4)
